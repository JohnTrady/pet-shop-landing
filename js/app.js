    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero-slider")) {
                const mainSlider = new core(".hero-slider", {
                    ...
                    parallax: true,
                    navigation: {
                        prevEl: ".hero-controls__arrow-left",
                        nextEl: ".hero-controls__arrow-right"
                    },
                    on: {}
                });
                const miniSlider = new core(".mini-slider", {
            ...
            if (document.querySelector(".swiper-reviews")) new core(".swiper-reviews", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".controls-reviews__arrow_left",
                    nextEl: ".controls-reviews__arrow_right"
                },
                on: {}
            });
        }
        ...
        function headerScroll() {
            ...
            const goUpBlockButton = document.querySelector(".go-up-button");
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                if (scrollTop >= startPoint) {
                    ...
                    if (goUpBlockButton) {
                        ...
                        goUpBlockButton.classList.remove("_show");
                    }
                }
                if (goUpBlockButton) if (scrollTop >= heroBlock.offsetHeight) goUpBlockButton.classList.add("_show"); else goUpBlockButton.classList.remove("_show");
